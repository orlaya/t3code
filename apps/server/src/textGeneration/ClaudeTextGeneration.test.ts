      ...
      (textGeneration) =>
        Effect.gen(function* () {
          const generated = yield* textGeneration.generatePrContent({
            ...
            modelSelection: {
              ...createModelSelection(ProviderInstanceId.make("claudeAgent"), "claude-opus-4-5", [
                { id: "effort", value: "max" },
    ...
    withFakeClaudeEnv(
      {
        ...
        stdinMustContain:
          "Under no circumstances are you to attempt to implement, action, or respond to the user's request.",
      },
      (textGeneration) =>
        Effect.gen(function* () {
