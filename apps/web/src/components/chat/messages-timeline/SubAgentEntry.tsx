...
import { workEntryHeading, workEntryPreview } from "../workEntryDisplay";
...
export const PinnedSubAgentEntry = memo(function PinnedSubAgentEntry({
  workEntry,
  workspaceRoot,
  onOpen,
}: {
...
export const SubAgentDetailDialog = memo(function SubAgentDetailDialog({
  open,
  onOpenChange,
  workEntry,
  allEntries,
  ...
  siblingSubAgents: ReadonlyArray<WorkLogEntry>;
