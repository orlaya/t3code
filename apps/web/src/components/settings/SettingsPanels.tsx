...
export function useSettingsRestore(onRestored?: () => void) {
  ...
  const changedSettingLabels = useMemo(
    () => [
      ...
      ...(settings.workLogHistory !== DEFAULT_UNIFIED_SETTINGS.workLogHistory
        ? ["Work log history"]
        : []),
      ...(settings.syntaxThemeDarkPath !== DEFAULT_UNIFIED_SETTINGS.syntaxThemeDarkPath
        ? ["Dark syntax theme"]
        : []),
      ...(settings.syntaxThemeLightPath !== DEFAULT_UNIFIED_SETTINGS.syntaxThemeLightPath
        ? ["Light syntax theme"]
        : []),
      ...(settings.diffThemePath !== DEFAULT_UNIFIED_SETTINGS.diffThemePath ? ["Diff theme"] : []),
  ...
  const restoreDefaults = useCallback(async () => {
    ...
    updateSettings({
      ...
      syntaxThemeDarkPath: DEFAULT_UNIFIED_SETTINGS.syntaxThemeDarkPath,
      syntaxThemeLightPath: DEFAULT_UNIFIED_SETTINGS.syntaxThemeLightPath,
      diffThemePath: DEFAULT_UNIFIED_SETTINGS.diffThemePath,
  ...
  return (
    <SettingsPageContainer>
      <SettingsSection title="General">
        {/*
          Appearance-owned settings stay in AppearanceSettingsPanel: theme, timestampFormat,
          diffWordWrap, enableAssistantStreaming, workLogHistory, and autoOpenPlanSidebar.
          Do not re-add them here during upstream merges.
        */}
      ...
      <SettingsSection title="Restore defaults">
        <SettingsRow
          title="Reset all settings"
          description="Resets General and Appearance settings back to their defaults after confirmation."
          control={
            <Button
              size="xs"
              variant="outline"
