...
// Protocol source: codex-cli 0.144.1
...
export interface ClientRequestParamsByMethod {
  ...
  readonly "remoteControl/enable":
    | typeof CodexSchema.V2NullableRemoteControlEnableParams.Type
    | null;
  readonly "remoteControl/disable":
    | typeof CodexSchema.V2NullableRemoteControlDisableParams.Type
    | null;
...
export const CLIENT_REQUEST_PARAMS = {
  ...
  "remoteControl/enable": Schema.Union([
    CodexSchema.V2NullableRemoteControlEnableParams,
    Schema.Null,
  ]),
  "remoteControl/disable": Schema.Union([
    CodexSchema.V2NullableRemoteControlDisableParams,
    Schema.Null,
  ]),
